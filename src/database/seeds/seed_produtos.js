...
export async function seed(knex) {
  ...
  await knex('produtos').insert([
    ...
    { id: 5, nome: 'Samsung Galaxy S2', preco: 7599, estoque: 180, id_marca: 2 },
    { id: 6, nome: 'Samsung Galaxy S2', preco: 5999, estoque: 250, id_marca: 2 },
    { id: 7, nome: 'Samsung Galaxy A5', preco: 2199, estoque: 400, id_marca: 2 },
    { id: 8, nome: 'Samsung Galaxy Z F', preco: 12999, estoque: 50, id_marca: 2 },
    { id: 9, nome: 'Samsung Galaxy Z F', preco: 7999, estoque: 80, id_marca: 2 },
    { id: 10, nome: 'Xiaomi 13 Pro', preco: 6599, estoque: 120, id_marca: 3 },
    { id: 11, nome: 'Xiaomi 13', preco: 5899, estoque: 150, id_marca: 3 },
    { id: 12, nome: 'Xiaomi Redmi Note', preco: 2299, estoque: 350, id_marca: 3 },
    ...
    { id: 19, nome: 'Samsung Galaxy S2', preco: 6899, estoque: 60, id_marca: 2 },
    { id: 20, nome: 'Xiaomi 14 Ultra', preco: 9599, estoque: 220, id_marca: 3 },
    { id: 21, nome: 'Xiaomi 10 Ultra', preco: 9599, estoque: 75, id_marca: 3 }
  ]);
}
